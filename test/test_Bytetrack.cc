...
// 参数分别为：变量名，默认参数，说明文字
DEFINE_string(model_path, "/home/sunrise/Desktop/RDKS100_Drowning/models/s_visdrone.hbm",
...
DEFINE_string(input_video, "/home/sunrise/Desktop/RDKS100_Drowning/tem/shiji.mp4",
              "Path to input video file. If set, video mode will be used.");
DEFINE_string(output_video, "visdrone.mp4",
